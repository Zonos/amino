(() => {
  var __webpack_modules__ = {
          ...
          return s(this, void 0, void 0, function* () {
            return new Promise((a, d) =>
              s(this, void 0, void 0, function* () {
                ...
                const r = { headers: {}, result: null, statusCode: t };
                if (t === m.NotFound) {
                  a(r);
                }
    ...
    2259: function (e, p, a) {
      ...
      async function run() {
        try {
          const { issue: p, payload: e } = s.context;
          const { pull_request: a } = e;
          if (!a) {
            throw new Error('No PR found');
          }
          const d = a.user.login;
          const { number: n, owner: t, repo: r } = p;
          if (!process.env.GITHUB_TOKEN) {
            throw new Error('No github token');
          }
          const l = s.getOctokit(process.env.GITHUB_TOKEN).rest;
          console.log('Trying to add reviewers', JSON.stringify(o));
          const m = await l.pulls.requestReviewers({
            owner: t,
            pull_number: n,
            repo: r,
            reviewers: o.filter(e => e !== d),
          });
          i.debug('Reviewer response: ' + JSON.stringify(m));
          console.log('Trying to add assignees: ', JSON.stringify([d]));
          const u = await l.issues.addAssignees({
            assignees: [d],
            issue_number: n,
            owner: t,
            repo: r,
          });
          i.debug('Response: ' + JSON.stringify(u));
        } catch (e) {
    ...
    2268: (e, p) => {
      ...
      async function auth(e) {
        ...
        const i = p
          ...
          ? 'user-to-server'
          : 'oauth';
        return { token: e, tokenType: i, type: 'token' };
      }
    ...
    4012: (e, p, a) => {
      ...
      var d = a(5477);
      var t = a(1229);
      var r = { NONTRANSITIONAL: 1, TRANSITIONAL: 0 };
      ...
      function processing(e, p, a) {
        ...
        return { error: d.error, string: t.join('.') };
      }
    ...
    5048: (e, p, a) => {
      ...
      const G = function isSameProtocol(e, p) {
        const a = new A(p).protocol;
        const d = new A(e).protocol;
        return a === d;
      };
      function fetch(e, p) {
        if (!fetch.Promise) {
        ...
        return new fetch.Promise(function (a, r) {
          ...
          h.on('response', function (e) {
            ...
            const n = { finishFlush: o.Z_SYNC_FLUSH, flush: o.Z_SYNC_FLUSH };
            if (i == 'gzip' || i == 'x-gzip') {
    ...
    5680: (e, p, a) => {
      ...
      function toOptions(e, p, a) {
        if (typeof e === 'string') {
          return { host: e, localAddress: a, port: p };
        }
        return e;
      }
    ...
    7443: (e, p, a) => {
      ...
      p.implementation = class URLImpl {
        ...
        set host(e) {
          ...
          d.basicURLParse(e, { stateOverride: 'host', url: this._url });
        }
        get hostname() {
        ...
        set hostname(e) {
          ...
          d.basicURLParse(e, { stateOverride: 'hostname', url: this._url });
        }
        get port() {
        ...
        set port(e) {
          ...
          if (e === '') {
            ...
            d.basicURLParse(e, { stateOverride: 'port', url: this._url });
          }
        }
        get pathname() {
          if (this._url.cannotBeABaseURL) {
        ...
        set pathname(e) {
          ...
          this._url.path = [];
          d.basicURLParse(e, { stateOverride: 'path start', url: this._url });
        }
        get search() {
        ...
        set search(e) {
          ...
          p.query = '';
          d.basicURLParse(a, { stateOverride: 'query', url: p });
        }
        get hash() {
        ...
        set hash(e) {
          ...
          this._url.fragment = '';
          d.basicURLParse(p, { stateOverride: 'fragment', url: this._url });
        }
        toJSON() {
          return this.href;
        }
            ...
            .map(e => {
              const p = e
                .map(e => {
                  ...
                  const { colspan: d, data: a, header: p, rowspan: t } = e;
                  const r = p ? 'th' : 'td';
        ...
        return {
          [Symbol.asyncIterator]: () => ({
            async next() {
              ...
              try {
                const e = await t({ headers: s, method: r, url: i });
                ...
                i = '';
                return { value: { data: [], headers: {}, status: 200 } };
              }
            },
          }),
        };
          ...
          .then(async r => {
            ...
            if (e.method === 'HEAD') {
              ...
              throw new i.RequestError(r.statusText, d, {
                request: e,
                response: { data: undefined, headers: a, status: d, url: t },
              });
            }
            if (d === 304) {
            ...
            if (d >= 400) {
              ...
              const s = new i.RequestError(toErrorMessage(p), d, {
                request: e,
                response: { data: p, headers: a, status: d, url: t },
              });
              throw s;
            }
            return getResponseData(r);
          })
          .then(e => ({ data: e, headers: a, status: d, url: t }))
          .catch(p => {
