...
export const BookmarkRemoveIcon = forwardRef<SVGSVGElement, IconProps>(
  ({ className, color, inlineBlock, size }, ref) => (
    ...
    >
      <path
        d="M14.475 8.586a.75.75 0 1 0-1.06-1.06L12 8.938l-1.414-1.414a.75.75 0 1 0-1.06 1.06L10.938 10l-1.414 1.414a.75.75 0 1 0 1.06 1.06L12 11.062l1.414 1.414a.75.75 0 0 0 1.06-1.06L13.062 10l1.414-1.414Z"
        fill="currentColor"
      />
      <path
        clipRule="evenodd"
