...
export const MoneyIcon = ({ size, color, className }: IconProps) => {
  return (
    <IconBase
      size={size}
      color={color}
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6 11a1 1 0 1 1 2 0v2a1 1 0 1 1-2 0v-2Zm8 1a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm3-2a1 1 0 0 0-1 1v2a1 1 0 1 0 2 0v-2a1 1 0 0 0-1-1Z"
        fill="currentColor"
      />
    </IconBase>
  );
