...
export const TW = () => {
  return (
    ...
    >
      <mask
        id="1cae7c06-4e72-41e2B404C089f99e74ed"
      ...
      <g mask="url(#1cae7c06-4e72-41e2B404C089f99e74ed)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V12H16V0H0Z"
        ...
        />
        <mask
          id="7120bbc9-562c-46c4-9276-69fe0d93256f"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="16"
        ...
        <g mask="url(#7120bbc9-562c-46c4-9276-69fe0d93256f)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 0V7H9V0H0Z"
