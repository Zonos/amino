...
export const HN = () => {
  return (
    ...
    >
      <mask
        id="3dc545f1-942d-4c23-91b7-4215f18230df"
      ...
      <g mask="url(#3dc545f1-942d-4c23-91b7-4215f18230df)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V12H16V0H0Z"
        ...
        />
        <mask
          id="090f3250-1670-4f34-91d1-8f888f6fc3d7"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="16"
        ...
        <g mask="url(#090f3250-1670-4f34-91d1-8f888f6fc3d7)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 0V4H16V0H0Z"
