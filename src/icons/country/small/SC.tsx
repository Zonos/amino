...
export const SC = () => {
  return (
    ...
    >
      <mask
        id="5980bebeF93b-4069-9603-6fc779d45840"
      ...
      <g mask="url(#5980bebeF93b-4069-9603-6fc779d45840)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V12H16V0H0Z"
        ...
        />
        <mask
          id="8db5f17dAb3f-4ab0Aa6c-90b91b4ef306"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="16"
        ...
        <g mask="url(#8db5f17dAb3f-4ab0Aa6c-90b91b4ef306)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
