...
export const AW = () => {
  return (
    ...
    >
      <mask
        id="2e2460d3Dfff-4669-8007-7674283d62be"
      ...
      <g mask="url(#2e2460d3Dfff-4669-8007-7674283d62be)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V12H16V0H0Z"
        ...
        />
        <mask
          id="81855f47-124d-4374-94e8D12c94272952"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="16"
        ...
        <g mask="url(#81855f47-124d-4374-94e8D12c94272952)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
