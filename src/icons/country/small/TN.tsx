...
export const TN = () => {
  return (
    ...
    >
      <mask
        id="2292f134-6915-4e48-8557-39ed3ef744ba"
      ...
      <g mask="url(#2292f134-6915-4e48-8557-39ed3ef744ba)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V12H16V0H0Z"
        ...
        />
        <mask
          id="268e137eF1b9-4114Abc7A11512ee2412"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="16"
        ...
        <g mask="url(#268e137eF1b9-4114Abc7A11512ee2412)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
