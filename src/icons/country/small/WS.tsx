...
export const WS = () => {
  return (
    ...
    >
      <mask
        id="4321c002-4f46-4724-86e5Eab954247d27"
      ...
      <g mask="url(#4321c002-4f46-4724-86e5Eab954247d27)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V12H16V0H0Z"
        ...
        />
        <mask
          id="c6481b50-44a7-47b0B0bd-1d172848f317"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="16"
        ...
        <g mask="url(#c6481b50-44a7-47b0B0bd-1d172848f317)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 0V7H8V0H0Z"
