...
export const PA = () => {
  return (
    ...
    >
      <mask
        id="474b1b38-1fca-4fbaB05eC1298ccbf189"
      ...
      <g mask="url(#474b1b38-1fca-4fbaB05eC1298ccbf189)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V12H16V0H0Z"
        ...
        />
        <mask
          id="a9ffea5a-37ed-433cAd0b-41a364d298d4"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="16"
        ...
        <g mask="url(#a9ffea5a-37ed-433cAd0b-41a364d298d4)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8 0V6H16V0H8Z"
