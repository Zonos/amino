...
export const FM = () => {
  return (
    ...
    >
      <mask
        id="9ad0917d-4de1-4955-8c7d-90d18d2f7c5c"
      ...
      <g mask="url(#9ad0917d-4de1-4955-8c7d-90d18d2f7c5c)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V24H32V0H0Z"
        ...
        />
        <mask
          id="4a50a9f0-7943-425fB4c2-4654fb7b56f6"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="32"
        ...
        <g mask="url(#4a50a9f0-7943-425fB4c2-4654fb7b56f6)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
