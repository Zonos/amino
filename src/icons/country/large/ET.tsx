...
export const ET = () => {
  return (
    ...
    >
      <mask
        id="4318dda4-5496-452e-9010-2e5a1f19555f"
      ...
      <g mask="url(#4318dda4-5496-452e-9010-2e5a1f19555f)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V24H32V0H0Z"
        ...
        />
        <mask
          id="8a30f8c8-1583-4eceB300-319c9fd298c6"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="32"
        ...
        <g mask="url(#8a30f8c8-1583-4eceB300-319c9fd298c6)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 0V8H32V0H0Z"
