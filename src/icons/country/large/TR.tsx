...
export const TR = () => {
  return (
    ...
    >
      <mask
        id="264e62dfB83f-4555B81aC030bc1b152a"
      ...
      <g mask="url(#264e62dfB83f-4555B81aC030bc1b152a)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V24H32V0H0Z"
        ...
        />
        <mask
          id="24fe8b2e-65e9-4731Ae99-5aa12dcfe39e"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="32"
        ...
        <g mask="url(#24fe8b2e-65e9-4731Ae99-5aa12dcfe39e)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
