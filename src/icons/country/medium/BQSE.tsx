...
export const BQSE = () => {
  return (
    ...
    >
      <mask
        id="3b3d6763-2762-4878-8186F4d9176adfde"
      ...
      <g mask="url(#3b3d6763-2762-4878-8186F4d9176adfde)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0H20V15H0V0Z"
        ...
        />
        <mask
          id="437868f4-56e1-49f5B306-6d91c04e40b8"
          maskUnits="userSpaceOnUse"
          x="0"
          y="2"
          width="20"
        ...
        <g mask="url(#437868f4-56e1-49f5B306-6d91c04e40b8)">
          <path
