...
export const TW = () => {
  return (
    ...
    >
      <mask
        id="87fe7934-7c15-41e9-9c55-12448f60694f"
      ...
      <g mask="url(#87fe7934-7c15-41e9-9c55-12448f60694f)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V15H20V0H0Z"
        ...
        />
        <mask
          id="86e4dd46E71c-4a8a-97f0-38a29846be3a"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="20"
        ...
        <g mask="url(#86e4dd46E71c-4a8a-97f0-38a29846be3a)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
