...
export const MK = () => {
  return (
    ...
    >
      <mask
        id="d4e6a712A89d-44ff-8450D3ae16317df0"
      ...
      <g mask="url(#d4e6a712A89d-44ff-8450D3ae16317df0)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V15H20V0H0Z"
        ...
        />
        <mask
          id="5001a5bcF0f9-4c1f-8d1f-95b07bf19ad0"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="20"
        ...
        <g mask="url(#5001a5bcF0f9-4c1f-8d1f-95b07bf19ad0)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
