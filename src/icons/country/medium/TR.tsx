...
export const TR = () => {
  return (
    ...
    >
      <mask
        id="287f3039-1eb4-4722Bd21-0585fef9472d"
      ...
      <g mask="url(#287f3039-1eb4-4722Bd21-0585fef9472d)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V15H20V0H0Z"
        ...
        />
        <mask
          id="ef2015cc-474a-452fA9bf-9b07d28112b9"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="20"
        ...
        <g mask="url(#ef2015cc-474a-452fA9bf-9b07d28112b9)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
