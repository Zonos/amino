...
export const JP = () => {
  return (
    ...
    >
      <mask
        id="431d4e67Fcbb-4292-8fb3-2bb56ee17f64"
      ...
      <g mask="url(#431d4e67Fcbb-4292-8fb3-2bb56ee17f64)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V15H20V0H0Z"
        ...
        />
        <mask
          id="c4cc93cdD548-47cc-8fdaCff9612efe3f"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="20"
        ...
        <g mask="url(#c4cc93cdD548-47cc-8fdaCff9612efe3f)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
