...
export const SG = () => {
  return (
    ...
    >
      <mask
        id="8f90f6eb-7e52-432e-8fa6Ae8fe44c2410"
      ...
      <g mask="url(#8f90f6eb-7e52-432e-8fa6Ae8fe44c2410)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V15H20V0H0Z"
        ...
        />
        <mask
          id="7dcf44c0-3a2e-4ec2-9a51A34ae574b94a"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="20"
        ...
        <g mask="url(#7dcf44c0-3a2e-4ec2-9a51A34ae574b94a)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 0V7.5H20V0H0Z"
