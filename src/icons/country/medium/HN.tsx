...
export const HN = () => {
  return (
    ...
    >
      <mask
        id="6f30aba9-408f-462e-8919-006f8e93f071"
      ...
      <g mask="url(#6f30aba9-408f-462e-8919-006f8e93f071)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 0V15H20V0H0Z"
        ...
        />
        <mask
          id="b400fb93-86fe-48f1B8b4F2543ac2cdf1"
          maskUnits="userSpaceOnUse"
          x="0"
          y="0"
          width="20"
        ...
        <g mask="url(#b400fb93-86fe-48f1B8b4F2543ac2cdf1)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 0V5H20V0H0Z"
