...
>(({ className, color, inlineBlock, secondaryColor, size }, ref) => (
  ...
  >
    ...
    <path
      clipRule="evenodd"
      d="M19.371 3.936a.75.75 0 0 1 0 1.06l-5.5 5.5a.75.75 0 0 1-1.06-1.06l5.5-5.5a.75.75 0 0 1 1.06 0m-7.84 13.445a.75.75 0 0 1-1.061 0l-3.85-3.85a.75.75 0 1 1 1.06-1.061l3.85 3.85a.75.75 0 0 1 0 1.06"
      fill="currentColor"
      fillRule="evenodd"
    />
  </IconBase>
