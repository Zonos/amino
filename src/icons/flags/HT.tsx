      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          <g mask={`url(#${ids[2]})`}>
            ...
            />
            <path
              d="m5.268 5.264.215-.218L8 7.523l-.215.218-2.517-2.477ZM4.481 5.845l.177-.252 3.237 2.463-.177.252L4.48 5.845ZM3.943 6.81l.14-.276 3.676 2.004-.139.276-3.677-2.003Z"
              fill="#FFD018"
            />
            <path
              fillRule="evenodd"
            ...
            />
            <path
              d="m10.68 5.264-.225-.218-2.712 2.277.225.217 2.711-2.276ZM11.499 5.845l-.185-.252-3.37 2.463v.461l3.555-2.672Z"
              fill="#FFD018"
            />
            <path
