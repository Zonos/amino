      ...
      <defs>
        <g id={`${ids[0]}`}>
          <g id={`${ids[1]}`}>
            ...
            />
            <use xlinkHref={`#${ids[2]}`} transform="scale(-1 1)" />
          </g>
          <use xlinkHref={`#${ids[1]}`} transform="rotate(72)" />
          <use xlinkHref={`#${ids[1]}`} transform="rotate(144)" />
          <use xlinkHref={`#${ids[1]}`} transform="rotate(216)" />
          <use xlinkHref={`#${ids[1]}`} transform="rotate(288)" />
        </g>
      </defs>
