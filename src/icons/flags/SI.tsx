...
export const SI = forwardRef<SVGSVGElement, Props>(({ height, width }, ref) => {
  const ids = useStableUniqueId(1);
  return (
    <FlagIconBase ref={ref} height={height} viewBox="0 0 640 480" width={width}>
      <defs>
        <clipPath id={`${ids[0]}`}>
          <path d="M-15 0h682.6v512H-15.1z" fillOpacity=".7" />
        </clipPath>
      </defs>
      <g
        clipPath={`url(#${ids[0]})`}
      ...
      >
        ...
        <path d="M-62 341.3H962V512H-62z" fill="#de2918" />
        <path d="M-62 170.7H962v170.6H-62z" fill="#08399c" />
        <path
