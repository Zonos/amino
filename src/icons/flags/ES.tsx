      ...
      <g clipPath={`url(#${ids[3]})`}>
        ...
        <g mask={`url(#${ids[0]})`}>
          ...
          <g mask={`url(#${ids[1]})`}>
            ...
            <path
              clipRule="evenodd"
              d="M7.388 3.603v-.082a1.53 1.53 0 0 0-.905-.31 1.806 1.806 0 0 0-.917-.157c-.466-.046-.935.157-.935.157-.473 0-.905.31-.905.31v.082l.565.567s.159.546 1.272.418v.001s.737-.02.79-.037l.063-.02c.144-.041.31-.09.407-.362l.565-.567Zm-1.825-.518Z"
              fill="#AD1619"
              fillRule="evenodd"
            />
            <path
            ...
            <path
              ...
              fillRule="evenodd"
            />
            <path d="M5.472 2.672h.224V3.4h-.224z" fill="#C88A02" />
            <path
            ...
            <g mask={`url(#${ids[2]})`}>
              <path d="M3.736 6.648h1.848v2.184H3.736z" fill="#FFC034" />
              <path d="M3.736 4.576h1.848v2.128H3.736z" fill="#AD1619" />
              <path d="M5.528 6.592h1.848V8.72H5.528z" fill="#AD1619" />
