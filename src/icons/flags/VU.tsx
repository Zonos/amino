...
export const VU = forwardRef<SVGSVGElement, Props>(({ height, width }, ref) => {
  ...
  return (
    <FlagIconBase ref={ref} height={height} viewBox="0 0 640 480" width={width}>
      ...
      <g clipPath={`url(#${ids[0]})`} transform="scale(.9375)">
        <g fillRule="evenodd">
          <path d="m0 0 347.4 219.4H768v73.2H347.4L0 512V0z" />
          <path
            d="M0 493.7 354.7 267H768v-22H354.7L0 18.3v32.9L332.8 256 0 460.8v32.9z"
            fill="#ff0"
          />
          <path d="m0 512 354.7-226.7H768V512H0z" fill="#40aa40" />
          <path d="m0 0 354.7 226.7H768V0H0z" fill="#ce0000" />
          <path
