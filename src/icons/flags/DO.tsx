    ...
    <FlagIconBase height={height} width={width} ref={ref} viewBox="0 0 16 12">
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          <path
            d="m6.818 5.555.498.048c-.085.89.026 1.265.206 1.265v.5c-.623 0-.815-.65-.704-1.813ZM9.213 5.555l-.497.048c.085.89-.026 1.265-.206 1.265v.5c.622 0 .815-.65.703-1.813Z"
            fill="#309404"
          />
          <path
            fill="#003994"
          ...
          <path
            fill="#DE2110"
            d="M8.055 5.3h.473v.738h-.473zM7.364 6.223h.472v.739h-.109a.364.364 0 0 1-.363-.364v-.375Z"
          />
          <path
