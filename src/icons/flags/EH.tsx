...
export const EH = forwardRef<SVGSVGElement, Props>(({ height, width }, ref) => {
  const ids = useStableUniqueId(1);
  return (
    <FlagIconBase ref={ref} height={height} viewBox="0 0 640 480" width={width}>
      <defs>
        <clipPath id={`${ids[0]}`}>
          <path d="M-158.7 0H524v512h-682.7z" fillOpacity=".7" />
        </clipPath>
      </defs>
      <g
        clipPath={`url(#${ids[0]})`}
      ...
      >
        ...
        />
        <path
          d="m363.1 294.2-25.8-18.9-26 19 10-30.5-26-18.8h32l9.9-30.5 9.8 30.4h32.1l-25.9 18.8"
          fill="#ff1800"
        />
        <path
