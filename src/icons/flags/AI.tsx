      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12.069 5.505s-.526.232-.412.668c.114.436.243.499.243.499s.186-.945.937-.945l-.768-.222Zm-.942 2.357s.432.379.78.091c.346-.288.348-.431.348-.431s-.934.23-1.252-.45l.123.79Zm2.603-.058s.021-.574-.42-.663c-.443-.088-.555 0-.555 0s.767.581.438 1.256l.536-.593Z"
            fill="#E18600"
          />
          <mask
            id={`${ids[2]}`}
