    ...
    <FlagIconBase height={height} width={width} ref={ref} viewBox="0 0 16 12">
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`} fill="#FFE017">
          ...
          <path d="m9.506 7.818-.602.617c-1.145-1.143-2.152-1.96-3.017-2.452-.879-.5-2.025-1.006-3.437-1.52l.29-.816c1.453.528 2.642 1.054 3.567 1.58.94.534 2.004 1.398 3.199 2.591Zm-6.776.35-.229-.31a4.64 4.64 0 0 1 .594-.361c.425-.215.852-.35 1.259-.362l.059-.001v.386h-.048c-.343.01-.72.13-1.1.322a4.264 4.264 0 0 0-.536.326Z" />
