      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          <g mask={`url(#${ids[4]})`}>
            ...
            />
            <path
              d="M11.766 9.148s.446.16.632.14c.206-.022.389-.257.527-.257.137 0 .402.235.608.257.186.02.55-.14.55-.14m-2.806-.68c.154-.13.49-.14.49-.14s.445.16.631.14c.206-.022.389-.257.527-.257.137 0 .402.236.608.257.186.02.55-.14.55-.14s.203-.229.458.013"
              stroke="#fff"
              strokeWidth=".533"
            />
            <path
          ...
          <path
            d="M11.482 9.197s.492.471.195.79c-.298.32-.57.134-.57.134m3.418-.924s-.492.471-.195.79c.297.32.57.134.57.134"
            stroke="#B85F3C"
            strokeWidth=".5"
          />
          <path
