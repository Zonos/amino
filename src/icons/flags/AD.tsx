    ...
    <FlagIconBase height={height} width={width} ref={ref} viewBox="0 0 16 12">
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M6.115 3.81h3.77v3.514s0 .31-.329.446c-.328.136-.713.087-.713.087s-.37-.08-.564 0a1.65 1.65 0 0 1-.255.084v.01L8 7.946a.393.393 0 0 1-.024.005v-.01a1.711 1.711 0 0 1-.255-.084c-.195-.08-.564 0-.564 0s-.385.049-.713-.087c-.328-.136-.33-.446-.33-.446V3.81Z"
          fill="#BF9937"
        />
        <mask
          id={`${ids[1]}`}
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8.094 3.765h1.895v1.95H8.094v-1.95Zm0 2.167h1.828v2.022H8.094V5.932Z"
            fill="#FEDF00"
          />
