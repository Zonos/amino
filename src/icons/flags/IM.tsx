      ...
      <g clipPath={`url(#${ids[2]})`}>
        ...
        <g mask={`url(#${ids[0]})`}>
          ...
          <g mask={`url(#${ids[1]})`}>
            ...
            <path
              fill="#FECA00"
              d="M6.831 4.883a.123.123 0 0 1-.074-.155c.021-.064.121-.17.183-.149l.868.304a.121.121 0 0 1 .08.105l.078.952c.005.067-.092.121-.158.127a.12.12 0 0 1-.128-.112l-.072-.818-.777-.254Z"
            />
            <path
              fill="#FECA00"
