      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="m4 4.138-.588.309.112-.655-.475-.463.657-.096L4 2.638l.294.595.657.096-.475.463.112.655L4 4.137ZM6.566 1.768a.18.18 0 0 1 .36.03l-.11 1.381a.18.18 0 1 1-.36-.029l.11-1.382Z"
            fill="#FECA00"
          />
          <path
            fillRule="evenodd"
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="m10.253 2.428.049-.662.496.442.645-.158-.268.608.35.565-.661-.066-.43.506-.14-.648-.615-.252.574-.335ZM10.977 5.6a.195.195 0 1 1-.235.31l-.962-.746a.177.177 0 0 1 .213-.282l.984.717Z"
            fill="#FECA00"
          />
          <path
            fillRule="evenodd"
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="m8.946 8.457.549.374-.63.208-.187.638-.393-.536-.663.02.387-.539-.224-.625.633.202.525-.406.003.664ZM5.552 7.478a.203.203 0 0 1-.147-.379l1.01-.394a.207.207 0 1 1 .148.385l-1.011.388Z"
            fill="#FECA00"
          />
          <path
