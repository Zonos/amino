    ...
    <FlagIconBase height={height} width={width} ref={ref} viewBox="0 0 16 12">
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M5.808 6.845a.553.553 0 0 1 1.105 0v.914H5.808v-.914Zm4.052 0a.553.553 0 1 1 1.106 0v.914H9.86v-.914Zm-2.21-.182a.737.737 0 0 1 1.474 0v1.463H7.65V6.663Z"
          fill="#272727"
        />
        <path
          fillRule="evenodd"
