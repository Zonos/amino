    ...
    <FlagIconBase height={height} width={width} ref={ref} viewBox="0 0 16 12">
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          />
          <path
            d="m6.234 3.666.022.073.073-.023h.003l.01-.004.04-.012.13-.037c.104-.03.23-.06.322-.073a4.596 4.596 0 0 1 .422-.036l.035-.001h.011v-.001l.08-.003-.008-.078-.126-1.463-.003-.034-.028-.02-.681-.484-.053-.037-.045.046-.619.642-.03.031.012.042.433 1.472Z"
            fill="#2E42A5"
            stroke="#fff"
            strokeWidth=".15"
          />
          ...
          <path
            d="m9.47 3.664-.02.076-.075-.024h-.003l-.01-.004-.04-.012a5.938 5.938 0 0 0-.13-.037 2.826 2.826 0 0 0-.322-.073 4.597 4.597 0 0 0-.423-.036l-.034-.001h-.011v-.001l-.08-.003.007-.078.127-1.463.003-.034.028-.02.681-.484.054-.039.045.05.584.639.028.03-.011.04-.398 1.474Z"
            fill="#2E42A5"
            stroke="#fff"
            strokeWidth=".15"
          />
