    ...
    <FlagIconBase height={height} width={width} ref={ref} viewBox="0 0 16 12">
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M6.668 4.634c-.257 0-.364-.214-.311-.442.028-.121.102-.275.222-.476l.429.257a2.864 2.864 0 0 0-.11.198.96.96 0 0 1 .25.113c.234.154.32.428.07.631-.048.04-.127.173-.17.302.119.007.204.025.283.071.221.13.2.37.032.553-.12.13-.279.237-.429.291-.25.09-.516.056-.516-.264v-.002c0-.013-.002-.036.11-.038h.021-.021c-.19-.003-.231-.103-.255-.283a1.852 1.852 0 0 1-.012-.182l-.002-.06-.003-.06V5.23c-.004-.057-.007-.097.123-.097h-.29v-.5h.29c.164 0 .255.055.307.17.03-.052.06-.101.094-.145a.386.386 0 0 0-.112-.024Zm.318.878.008-.008-.003.004-.005.004Zm-.218.149s-.001 0 0 0Zm0-.189v.008-.015.007Z"
          fill="#A8AC71"
        />
        <path
          fillRule="evenodd"
