...
>(({ className, color, inlineBlock, secondaryColor, size }, ref) => (
  ...
  >
    ...
    />
    <path
      d="M14.778 16.39a.76.76 0 0 0-.32 1.016.74.74 0 0 0 1.005.323 7.54 7.54 0 0 0 4.033-6.697 7.6 7.6 0 0 0-.333-2.232.743.743 0 0 0-.932-.497.755.755 0 0 0-.491.943c.172.563.266 1.163.266 1.786a6.04 6.04 0 0 1-3.228 5.359"
      fill="currentColor"
    />
  </IconBase>
));
