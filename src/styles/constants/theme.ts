export const theme = {
  ...
  /** @info 0px 1px 3px 0px oklch(64.68% 0.21157 249.91 / 0.04), 0px 0px 0px 1px var(--amino-blue-500) inset, 0px -1px 1px 1px oklch(64.68% 0.21157 249.91 / 0.12) inset */
  /* THIS IS GENERATED VARIABLE! DON'T TOUCH IT!!! */
  shadowSelectActive: 'var(--amino-shadow-select-active)',
  /** @info 0px 1px 3px 0px oklch(64% 0.277 24.49 / 0.04), 0px 0px 0px 1px var(--amino-red-500) inset, 0px -1px 1px 1px oklch(64% 0.277 24.49 / 0.12) inset */
  /* THIS IS GENERATED VARIABLE! DON'T TOUCH IT!!! */
  ...
  /** @info oklch(98.16% 0.001972 243.25) */
  /* THIS IS GENERATED VARIABLE! DON'T TOUCH IT!!! */
  ...
  /** @info linear-gradient(180deg, oklch(66.98% 0.236 39.73) 0%, oklch(71% 0.225 46.37) 100%) */
  /* THIS IS GENERATED VARIABLE! DON'T TOUCH IT!!! */
