    ...
    <FlagIconBase height={height} width={width} ref={ref} viewBox="0 0 16 12">
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`} fill="#FFE017">
          ...
          />
          <path d="M2.157 6.202l-.14-.359C3.56 5.228 4.724 4.83 5.514 4.651a29.368 29.368 0 013.821-.583l.034.384c-1.372.125-2.63.317-3.772.576-.766.173-1.914.565-3.44 1.174z" />
          <path d="M9.57 3.832l-.113.368c-1.166-.368-2.116-.526-2.846-.477l-.025-.385c.784-.052 1.778.113 2.984.494zM9.974 5.89l-.216.318c-.594-.413-1.326-.62-2.201-.62v-.386c.948 0 1.756.229 2.417.688z" />
          <path d="M9.651 6.005l.098.373c-1.28.347-2.484.544-3.609.59-1.132.047-2.452-.15-3.96-.591l.105-.37c1.472.43 2.752.62 3.84.576 1.095-.045 2.27-.238 3.526-.578z" />
          <path d="M9.506 7.818l-.602.617c-1.145-1.143-2.152-1.96-3.017-2.452-.879-.5-2.025-1.006-3.437-1.52l.29-.816c1.453.528 2.642 1.054 3.567 1.58.94.534 2.004 1.398 3.199 2.591zM2.73 8.168l-.229-.31a4.64 4.64 0 01.594-.361c.425-.215.852-.35 1.259-.362l.059-.001v.386h-.048c-.343.01-.72.13-1.1.322a4.264 4.264 0 00-.536.326z" />
          <path d="M2.906 8.301l.096-.373c1.27.335 2.25.501 2.933.501.68 0 1.694-.196 3.033-.59l.106.37c-1.37.403-2.415.606-3.14.606-.721 0-1.73-.172-3.028-.514zM2.411 4.847l.604-.616.883.887-.603.616-.884-.887z" />
          <path d="M7.418 7.924l.449-.739 1.402.872-.45.74-1.401-.873z" />
        </g>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
