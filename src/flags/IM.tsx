      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M4 4.138l-.588.309.112-.655-.475-.463.657-.096L4 2.638l.294.595.657.096-.475.463.112.655L4 4.137zM6.566 1.768a.18.18 0 01.36.03l-.11 1.381a.18.18 0 11-.36-.029l.11-1.382z"
            fill="#FECA00"
          />
          <path
            fillRule="evenodd"
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M10.253 2.428l.049-.662.496.442.645-.158-.268.608.35.565-.661-.066-.43.506-.14-.648-.615-.252.574-.335zM10.977 5.6a.195.195 0 11-.235.31l-.962-.746a.177.177 0 01.213-.282l.984.717z"
            fill="#FECA00"
          />
          <path
            fillRule="evenodd"
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8.946 8.457l.549.374-.63.208-.187.638-.393-.536-.663.02.387-.539-.224-.625.633.202.525-.406.003.664zM5.552 7.478a.203.203 0 01-.147-.379l1.01-.394a.207.207 0 11.148.385l-1.011.388z"
            fill="#FECA00"
          />
          <path
            d="M6.831 4.883a.123.123 0 01-.074-.155c.021-.064.12-.17.183-.149l.868.304a.121.121 0 01.08.105l.078.952c.005.067-.092.121-.158.127a.12.12 0 01-.128-.112l-.072-.818-.777-.254z"
            fill="#FECA00"
          />
          <path
