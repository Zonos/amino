    ...
    >
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`}>
          ...
          />
          <path
            d="M11.81 7.515l-.28-.696a3.976 3.976 0 011.481-.31c.475 0 .969.105 1.48.31l-.278.696a3.235 3.235 0 00-1.202-.255c-.374 0-.774.084-1.201.255z"
            fill="#82B2CB"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12.5 8a.5.5 0 100-1 .5.5 0 000 1z"
            fill="#FECA00"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12.8 8.8a.5.5 0 100-1 .5.5 0 000 1z"
            fill="#8A4E22"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12 8.4a.5.5 0 100-1 .5.5 0 000 1zM13.7 8.4a.5.5 0 100-1 .5.5 0 000 1zM13.35 9.5c.193 0 .35-.224.35-.5s-.157-.5-.35-.5c-.193 0-.35.224-.35.5s.157.5.35.5zM12.15 9.5c.193 0 .35-.224.35-.5s-.157-.5-.35-.5c-.193 0-.35.224-.35.5s.157.5.35.5z"
            fill="#AF0100"
          />
