    ...
    >
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <g mask={`url(#${ids[1]})`} fillRule="evenodd" clipRule="evenodd">
          ...
          />
          <path
            d="M5.456 8.052c1.311 0 2.438 1.459 2.438 1.459l.052.055A1.47 1.47 0 018 9.511s1.314-1.459 2.625-1.459c1.312 0-.944 2.124-2.403 2.124 0 0-.15-.014-.275-.076-.124.062-.274.076-.274.076-1.459 0-3.527-2.124-2.216-2.124z"
            fill="#006B49"
          />
          <path
            d="M5.456 8.052c1.311 0 2.438 1.459 2.438 1.459l.052.055A1.47 1.47 0 018 9.511s1.314-1.459 2.625-1.459c1.312 0-.944 2.124-2.403 2.124 0 0-.15-.014-.275-.076-.124.062-.274.076-.274.076-1.459 0-3.527-2.124-2.216-2.124z"
