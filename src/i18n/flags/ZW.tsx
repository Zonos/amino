  ...
  return (
    ...
    >
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <path
          d="M.298-.401L-.5-.995V12.98l.794-.575L8.459 6.48l.551-.4-.546-.406L.298-.401z"
          fill="#F7FCFF"
          stroke="#272727"
        />
        <mask
        ...
        <g mask={`url(#${ids[2]})`} fillRule="evenodd" clipRule="evenodd">
          <path
            d="M3.74 7.139L1.85 8.664l.866-2.038-1.489-1.434h1.758l.721-1.73.766 1.73h1.755L4.66 6.626l.785 2.038L3.739 7.14z"
            fill="#E31D1C"
          />
          <path
            d="M2.509 4.21s-.028-.066.134-.124c.162-.058.212-.182.338-.091.127.091.207-.092.243.17.037.264.137.678.137.678L5.005 6.08h-.31s-.48.706-.4 1.326c0 0-.332-.05-.782-.05s-.745.107-.745.107l-.26-.961s.095-.162.135-.292c.04-.13.208-.155.208-.258 0-.104-.165-.19-.083-.459.083-.268.083-1.07.083-1.07s-.26-.115-.208-.115c.053 0 .174-.096.087-.096H2.51z"
            fill="#FECA00"
          />
        </g>
      </g>
