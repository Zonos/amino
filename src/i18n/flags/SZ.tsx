    ...
    >
      ...
      <g mask={`url(#${ids[0]})`}>
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M12.048 4.301l.505-.645.895.645-.895.662-.505-.662z"
          fill="#F7FCFF"
        />
        <path
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M12.048 6.301l.505-.645.895.645-.895.662-.505-.662z"
          fill="#F7FCFF"
        />
        <path
        ...
        <g mask={`url(#${ids[1]})`} fillRule="evenodd" clipRule="evenodd">
          <path
            d="M7.962 2.84s-.464.563-.309 1.1c.155.537.515.48.515.953s-.167.955 0 .955c.166 0 .224.327.072.548-.152.221-.287.228-.278.588.01.36.796.714.415.714-.381 0-.884.37-.724.37.16 0 .996.288.996.666v.682H4.286V2.84h3.676z"
            fill="#272727"
          />
          <path
            d="M5.91 4.962h-.218v.884h.217v-.884zm.64 0h-.217v.884h.217v-.884zm-.537 0h.217v.884h-.217v-.884zm.858 0h-.218v.884h.218v-.884zm.103 0h.217v.884h-.217v-.884zm.537 0h-.217v.884h.217v-.884zM5.692 6.23h.217v.885h-.217V6.23zm.858 0h-.217v.885h.217V6.23zm-.537 0h.217v.885h-.217V6.23zm.858 0h-.218v.885h.218V6.23zm.103 0h.217v.885h-.217V6.23zm.537 0h-.217v.885h.217V6.23z"
            fill="#F7FCFF"
          />
          <path
          ...
          />
          <path
            d="M6.616 3.536c-.304.094-.444.892-.41 1.085.034.193.138-.024.138-.024s.21.457.232.58c.021.123.132-.186.132-.186s.365.252.415.532c.05.28.124-.32.124-.32l.082-.015-.052-.297.158.135-.049-.276s.119.155.089-.016l-.047-.266-.041-.234.156-.027s-.623-.766-.927-.671z"
            fill="#3D58DB"
          />
        </g>
        <path
