...
export const TV = forwardRef<SVGSVGElement, Props>(({ height, width }, ref) => {
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${ids[0]})`}>
        ...
        <path fill="#fff" fillRule="evenodd" d="M0 0h396v196.6H0z" />
        ...
        <path
          fill="#c00"
          d="M302.6 134.5l-32.8-.3 123.5 61.5-.8-14-90-47.2zM30.7 196.7L146.5 136l-30.4.2L0 196.6"
        />
        <path
          fill="#006"
          d="M394.6 17.3L301 63.6l92.3.4v69h-78.6l77.9 42.3 1.1 21.4-41.6-.5-113.8-55.8v56.3h-82.9v-56.3L48.6 196.6l-48.2.1v196.4h785.8V.3L395.4 0M.4 22.2L0 63l82.7 1L.4 22.2z"
        />
