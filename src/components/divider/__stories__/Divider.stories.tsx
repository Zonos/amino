...
export const Basic = () => (
  <div className="flex flex-col gap-5">
    <div className="flex flex-col gap-5">
      ...
      <div className="border-amino rounded-amino-6 flex justify-evenly border">
        <ArrowLeftIcon />
        <Divider vertical />
        <CircleIcon />
        <Divider vertical />
      ...
      <div
        className="border-amino rounded-amino-6 flex justify-evenly border p-2"
      >
        <ArrowLeftIcon />
        <Divider vertical />
        <CircleIcon />
    ...
    <div className="flex gap-5">
      <div
        className="border-amino rounded-amino-6 flex flex-col justify-evenly
          border"
      >
        <ArrowUpIcon />
        <Divider />
