  ...
  return (
    <div
      ...
      className={cn(
        ...
        shadow-[inset_0_0_1px_1px_rgb(var(--amino-gray-200))]`,
        `after:absolute
        after:top-[calc(var(--amino-glow-wrapper-y)*1px-min(50%,200px))]
        after:left-[calc(var(--amino-glow-wrapper-x)*1px-min(50%,200px))]
        after:-z-1 after:h-[min(100%,400px)] after:w-[min(100%,400px)]
        after:bg-(image:--amino-glow-wrapper-background) after:opacity-0
        after:blur-[20px] after:transition-opacity after:duration-500
        after:content-[""]`,
