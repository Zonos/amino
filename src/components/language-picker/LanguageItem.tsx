...
export const LanguageItem = ({
  ...
  return (
    <button
      className={cn(
        'flex cursor-pointer items-center gap-amino-12 rounded-amino8 border-none bg-transparent px-amino-12 py-[10px] text-left opacity-0 translate-y-[8px] transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-gray-100 [&:hover_.flag]:animate-wiggle [&:hover_.chevron]:translate-x-[2px] [&:hover_.chevron]:opacity-100',
        isSelected &&
