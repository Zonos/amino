export const shadow = {
  'v3-shadow-base': `0px 0px 0px 1px rgba(255, 255, 255, 0.12), 0px 1px 3px rgba(0, 0, 0, 0.6), 0px 1px 4px rgba(0, 0, 0, 0.7)`,
  ...
  'shadow-button-primary':
    '0px 0px 0px 1px #000, 0px -1px 1px 0px rgba(0, 0, 0, 0.20) inset, 0px 0px 0px 1px rgba(255, 255, 255, 0.08) inset, 0px 1px 3px 0px rgba(95, 146, 246, 0.40)',
  'shadow-button-success':
    '0px 0px 0px 1px #000, 0px -1px 1px 0px rgba(0, 0, 0, 0.20) inset, 0px 0px 0px 1px rgba(255, 255, 255, 0.08) inset, 0px 1px 3px 0px rgba(86, 199, 111, 0.60)',
  'shadow-button-danger':
    '0px 0px 0px 1px #000, 0px -1px 1px 0px rgba(0, 0, 0, 0.20) inset, 0px 0px 0px 1px rgba(255, 255, 255, 0.08) inset, 0px 1px 3px 0px rgba(249, 92, 103, 0.60)',
  'shadow-button-warning':
    '0px 0px 0px 1px #000, 0px -1px 1px 0px rgba(0, 0, 0, 0.20) inset, 0px 0px 0px 1px rgba(255, 255, 255, 0.08) inset, 0px 1px 3px 0px rgba(248, 140, 83, 0.60)',
