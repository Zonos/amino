export const shadow = {
  ...
  'shadow-button-primary':
    '0px -1px 1px 0px rgba(0, 0, 0, 0.20) inset, 0px 0px 0px 0.5px #000, 0px 1px 3px 0px rgba(95, 146, 246, 0.40)',
  'shadow-button-success':
    '0px -1px 1px 0px rgba(0, 0, 0, 0.20) inset, 0px 0px 0px 1px rgba(255, 255, 255, 0.08) inset, 0px 0px 0px 0.5px #000, 0px 1px 3px 0px rgba(86, 199, 111, 0.60)',
  ...
  'shadow-button-standard':
    '0px -1px 1px 0px rgba(0, 0, 0, 0.40) inset, 0px 0px 2px 1px rgba(255, 255, 255, 0.08) inset, 0px 1px 3px 0px rgba(0, 0, 0, 0.80)',
} as const;
