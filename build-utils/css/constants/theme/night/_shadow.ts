export const shadow = {
  ...
  'shadow-button-standard':
    '0px 0px 0px 1px rgba(255, 255, 255, 0.08) inset, 0px 1px 3px 0px rgba(0, 0, 0, 0.80), 0px 0px 2px 1px rgba(255, 255, 255, 0.08) inset, 0px -1px 1px 0px rgba(0, 0, 0, 0.40) inset, 0px 0px 0px 0.5px rgba(0, 0, 0, 0.50)',
