export const shadow = {
  'v3-shadow-base': `0px 1px 3px 0px rgba(10, 10, 11, 0.1), 0px 1px 2px rgba(10, 10, 11, 0.06), 0px 0px 0px 1px rgba(110, 110, 120, 0.1)`,
  'v3-shadow-medium': `0px 2px 4px 0px rgba(10, 10, 11, 0.06), 0px 4px 6px rgba(10, 10, 11, 0.1), 0px 0px 0px 1px rgba(110, 110, 120, 0.1)`,
  'v3-shadow-large': `0px 4px 6px 0px rgba(10, 10, 11, 0.05), 0px 10px 15px rgba(10, 10, 11, 0.1), 0px 0px 0px 1px rgba(110, 110, 120, 0.1)`,
  'v3-shadow-xl': `0px 10px 10px 0px rgba(12, 12, 13, 0.04), 0px 20px 25px rgba(10, 10, 11, 0.1), 0px 0px 0px 1px rgba(110, 110, 120, 0.1)`,
  'v3-shadow-xxl':
    '0px 32px 50px 0px rgba(10, 10, 11, 0.24), 0px 0px 0px 1px rgba(110, 110, 120, 0.1)',
  'v3-shadow-inset':
  ...
  'shadow-button-primary':
    '0px 0px 0px 1px var(--amino-primary), 0px 1px 0px 0px rgba(255, 255, 255, 0.16) inset, 0px 0px 0px 4px rgba(0, 0, 0, 0.0), 0px -1px 0px 0px rgba(255, 255, 255, 0.08) inset, 0px 2px 2px -1px rgba(47, 54, 159, 0.24), 0px 4px 4px -2px rgba(47, 54, 159, 0.12)',
  'shadow-button-primary-focus':
    '0px 0px 0px 1px var(--amino-primary), 0px 1px 0px 0px rgba(255, 255, 255, 0.16) inset, 0px 0px 0px 4px rgba(0, 0, 0, 0.12), 0px -1px 0px 0px rgba(255, 255, 255, 0.08) inset, 0px 2px 2px -1px rgba(47, 54, 159, 0.24), 0px 4px 4px -2px rgba(47, 54, 159, 0.12)',
  'shadow-button-success':
    '0px 0px 0px 1px var(--amino-green-500), 0px 1px 0px 0px rgba(255, 255, 255, 0.16) inset, 0px 0px 0px 4px rgba(0, 0, 0, 0.00), 0px -1px 0px 0px rgba(255, 255, 255, 0.06) inset, 0px 2px 2px -1px rgba(1, 87, 31, 0.24), 0px 4px 4px -2px rgba(1, 87, 31, 0.12)',
  'shadow-button-success-focus':
    '0px 0px 0px 1px var(--amino-green-500), 0px 1px 0px 0px rgba(255, 255, 255, 0.16) inset, 0px 0px 0px 4px rgba(0, 0, 0, 0.12), 0px -1px 0px 0px rgba(255, 255, 255, 0.06) inset, 0px 2px 2px -1px rgba(1, 87, 31, 0.24), 0px 4px 4px -2px rgba(1, 87, 31, 0.12)',
  'shadow-button-danger':
    '0px 0px 0px 1px var(--amino-red-500), 0px 1px 0px 0px rgba(255, 255, 255, 0.16) inset, 0px 0px 0px 4px rgba(0, 0, 0, 0.00), 0px -1px 0px 0px rgba(255, 255, 255, 0.06) inset, 0px 2px 2px -1px rgba(138, 2, 13, 0.24), 0px 4px 4px -2px rgba(138, 2, 13, 0.12)',
  'shadow-button-danger-focus':
    '0px 0px 0px 1px var(--amino-red-500), 0px 1px 0px 0px rgba(255, 255, 255, 0.16) inset, 0px 0px 0px 4px rgba(0, 0, 0, 0.12), 0px -1px 0px 0px rgba(255, 255, 255, 0.06) inset, 0px 2px 2px -1px rgba(138, 2, 13, 0.24), 0px 4px 4px -2px rgba(138, 2, 13, 0.12)',
  ...
  'shadow-select-active':
    '0px 1px 3px 0px oklch(62% 0.226011 249.91 / 0.04), 0px 0px 0px 1px var(--amino-blue-500) inset, 0px -1px 1px 1px oklch(62% 0.226011 249.91 / 0.12) inset',
  'shadow-select-error':
    '0px 1px 3px 0px oklch(64% 0.277484 24.49 / 0.04), 0px 0px 0px 1px var(--amino-red-500) inset, 0px -1px 1px 1px oklch(64% 0.277484 24.49 / 0.12) inset',
} as const;
